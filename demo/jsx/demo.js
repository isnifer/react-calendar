...
const leftRangeDate = new Date(2012, 7, 20)
const rightRangeDate = new Date(2016, 7, 27)
        ...
        <div className="demo__part">
          <div className="demo__description">
            <div className="demo__ru">
              ...
              Атрибут <em>initialDate</em> - instanceof `Date`. Дата, которая будет выбрана в
              календаре <br />
              по умолчанию. Важно! Эта дата, должна быть частью периода календаря. <br />
              Атрибут <em>locale</em> - instanceof `String`. Несколько встроенных локалей на выбор:{' '}
              <br />
              RU, EN, DE, FR, ITA, POR, ESP
            </div>
            <div className="demo__en">
              A little more complex version of the calendar. The component has received three new
              attribute. <br />
              ...
              Attribute <em>initialDate</em> - instanceof `Date`. Date to be selected on the
              calendar default. <br />
              Important! This date should be part of the period of the calendar. <br />
              Attribute <em>locale</em> - instanceof `String`. Several built-in locales to choose
              from: <br />
              RU, EN, DE, FR, ITA, POR, ESP.
            </div>
          </div>
