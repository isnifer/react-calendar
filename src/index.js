...
import { MONTH_NAMES, WEEK_NAMES } from './locale'
...
class Datepicker extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.range !== this.props.range) {
      ...
      nextProps.minimumDate !== this.props.minimumDate ||
  ...
  renderWeekdayNames() {
    return WEEK_NAMES[this.props.locale].map((weekname, i) => {
      return (
        <th className="calendar__weekday-name" key={i}>
          {weekname}
        </th>
      )
    })
    ...
    return (
      <div className="calendar">
        <div className="calendar__head">
          {!this.props.disableNavigation && !this.props.outsideNavigation
        ...
        {this.state.dateVisible && (
          <table className="calendar__month">
            <thead>
              <tr className="calendar__week-names">{this.renderWeekdayNames()}</tr>
            </thead>
